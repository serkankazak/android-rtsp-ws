package com.example.try1.ui.cam4;
...
import com.example.try1.databinding.FragmentCam4Binding;
...
public class Cam4Fragment extends Fragment {
    ...
    private FragmentCam4Binding binding;
    VideoView videoView4;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        Cam4ViewModel cam4ViewModel =
                new ViewModelProvider(this).get(Cam4ViewModel.class);

        binding = FragmentCam4Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        imageView = binding.imageViewCam4;
        videoView4 = binding.videoViewCam4;
        ...
        if (DrCa) {
            ...
            videoView4.setVideoPath("rtsp://<user>:<password>@192.168.1.49:554/22");
            videoView4.start();
