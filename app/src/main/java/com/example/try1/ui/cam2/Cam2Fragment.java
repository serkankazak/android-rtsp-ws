package com.example.try1.ui.cam2;
...
import com.example.try1.databinding.FragmentCam2Binding;
...
public class Cam2Fragment extends Fragment {
    ...
    private FragmentCam2Binding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        Cam2ViewModel cam2ViewModel =
                new ViewModelProvider(this).get(Cam2ViewModel.class);

        binding = FragmentCam2Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        imageView = binding.imageViewCam2;
