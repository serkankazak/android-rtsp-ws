package com.example.try1.ui.cam5;
...
import com.example.try1.databinding.FragmentCam5Binding;
...
public class Cam5Fragment extends Fragment {
    ...
    private FragmentCam5Binding binding;
    VideoView videoView5;

    public View onCreateView(@NonNull LayoutInflater inflater,
                             ViewGroup container, Bundle savedInstanceState) {
        Cam5ViewModel cam5ViewModel =
                new ViewModelProvider(this).get(Cam5ViewModel.class);

        binding = FragmentCam5Binding.inflate(inflater, container, false);
        View root = binding.getRoot();

        imageView = binding.imageViewCam5;
        videoView5 = binding.videoViewCam5;
        ...
        if (DrCa) {
            ...
            videoView5.setVideoPath("rtsp://<user>:<password>@192.168.1.26:554/22");
            videoView5.start();
            ...
            videoView5.setVisibility(View.INVISIBLE);
